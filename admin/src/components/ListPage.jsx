...
// HELPER FUNCTION;
// This function will give you output as DD - MM - YY
...
// this function will normalized schedule map: ex - 'YYY-MM-DD
                  ...
                  <div className={doctorListStyles.statsContainer}>
                    ...
                    <div className={doctorListStyles.actionContainer}>
                      <div className="flex items-center gap-2">
                        ...
                        <div className={doctorListStyles.feesLabel}>Fee:</div>
