        ...
        <div className="mb-6">
          ...
          <div className={dashboardStyles.searchContainer}>
            ...
            <button
              ...
              className={
                dashboardStyles.clearButton +
                " " +
                dashboardStyles.cursorPointer
              }
            >
              Clear
            </button>
                ...
                {visibleDoctors.map((d, idx) => (
                  <tr
                    ...
                    className={
                      ...
                      " " +
                      (idx % 2 === 0
                        ? dashboardStyles.tableRowEven
                        : dashboardStyles.tableRowOdd)
                    }
                  >
                    <td
                      className={
                    ...
                    <td
                      className={
                        dashboardStyles.tableCell +
                        " " +
                        dashboardStyles.doctorSpecialization
                      }
                    >
                      {d.specialization}
                    </td>
                    ...
                    <td
                      className={
                        dashboardStyles.tableCell +
                        " " +
                        dashboardStyles.appointmentsText
                      }
                    >
    ...
    <div className={dashboardStyles.mobileDoctorCard}>
      <div className={dashboardStyles.mobileDoctorHeader}>
        <div className=" flex items-center gap-3">
          <img
            src={d.image}
            alt={d.name}
            className={dashboardStyles.mobileDoctorImage}
          />
          <div>
      ...
      <div className={dashboardStyles.mobileStatsGrid}>
        <div>
          ...
          <div className={dashboardStyles.mobileStatValue}>
            {d.appointments.total}
          </div>
        </div>
        ...
        <div>
          ...
          <div
            className={
              dashboardStyles.mobileStatValue +
              " " +
              dashboardStyles.textEmerald600
            }
          >
            {d.appointments.completed}
          </div>
