...
//  this function takes slot with dtae time and return a date obj;
...
const AppointmentsPage = () => {
  ...
  }, [appointments, query, filterSpeciality, filterDate]);
  ...
  async function adminCancelAppointment(id) {
    ...
    try {
      ...
      const data = await res.json();
      const updated = data?.appointment || data?.appointments?.[0];
        ...
        <header className={pageStyles.headerContainer}>
          ...
          <div className={pageStyles.headerControlsSection}>
            <div className="flex flex-col items-center gap-3 w-full">
              {/* Search */}
              <div className={`${pageStyles.searchContainer} w-full max-w-md`}>
              ...
              <div className="flex items-center gap-3">
                <div className={pageStyles.dateFilter}>
                  <Calendar size={14} className={pageStyles.searchIcon} />
                  <input
                    type="date"
