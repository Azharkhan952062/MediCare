...
import { Calendar, CheckCircle, Eye, EyeClosed, Plus, User, XCircle, Trash2 } from "lucide-react";

// HELPERS FUNCTIONS;
// Tis function will give ouput in minutes and according to that it will manage am : pm;
...
const AddPage = () => {
  ...
  async function handleAdd(e) {
    ...
    try {
      ...
      const API_BASE =  `${import.meta.env.VITE_BACKEND_URL || "https://medicare-backend-cnj8.onrender.com"}/api`;
