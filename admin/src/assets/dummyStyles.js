...
export const navbarStyles = {
  ...
  // logoImage: "w-50 h-50 rounded-full",
  ...
  logoLink: "text-xl font-bold text-green-700 leading-tight",

  logoSubtext: "text-xs text-gray-500 leading-tight",
  ...
  rightContainer: "flex items-center gap-4 pr-12",
...
export const serviceListStyles = {
  ...
  // Grid styles
  servicesGrid: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6",
