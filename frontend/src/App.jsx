...
const App = () => {
  // to lock horizontal overflow for all PageSwapEvent;
  useEffect(() => {
    ...
    <>
      ...
      <div className="overflow-x-hidden bg-white text-gray-900">
        <Routes>
          ...
          <Route
            path="/doctor-admin/:id/dashboard"
          ...
          <Route path="/appointment/success" element={<VerifyPayments />} />
          <Route path="/appointment/cancel" element={<VerifyPayments />} />
