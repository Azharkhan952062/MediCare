      ...
      <div className={appointmentPageStyles.maxWidthContainer}>
        ...
        <div className={appointmentPageStyles.doctorGrid}>
          {appointmentData.map((item) => (
            <div key={item.id} className={cardStyles.doctorCard}>
              <div className={appointmentPageStyles.doctorImageContainer}>
                <img
        ...
        <div className={appointmentPageStyles.serviceGrid}>
          {serviceData.map((item) => (
            <div key={item.id} className={cardStyles.serviceCard}>
              <div className={appointmentPageStyles.serviceImageContainer}>
                <img
                  src={item.image || "/placeholder-service.png"}
                  alt={item.name}
                  className={cardStyles.image}
                  loading="lazy"
                />
              ...
              <h2 className={cardStyles.serviceName}>{item.name}</h2>
